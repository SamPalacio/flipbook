...
var OneBook3D = {
	...
	initWithData:function(FRDATA){
		...
		this.LNG = {
			...
			hlpClickToOpen:['Presione para abrir','Открой меня'],
			hlpUseMousewheel:['Click to open','Используйте колесо мыши<br>для листания'],
			hlpUseMousewheelGL:[['Click to open','for easy viewing'],['Используйте колесо','мыши для листания']],
